...
class ERPComponentTest {
    ...
    fun webViewState_loading_isCorrect() {
        assertTrue(
            "Loading state should be instance of WebViewState.Loading", true
        )
    }
    ...
    fun webViewState_success_hasCorrectDefaultMessage() {
        ...
        assertTrue(
            "Success state should show message by default", successState.showSuccessMessage
        )
    }
    ...
    fun webViewState_error_hasCorrectDefaultType() {
        ...
        assertEquals(
            "Error state should default to NETWORK type", ErrorType.NETWORK, errorState.errorType
        )
    }
    ...
    fun errorInfo_networkError_hasCorrectContent() {
        ...
        assertTrue(
            "Message should contain connection guidance",
            errorInfo.message.contains("Unable to connect")
        )
        assertTrue(
            "Tip should provide helpful guidance",
    ...
    fun errorType_allTypes_areDefined() {
        val allTypes = ErrorType.entries.toTypedArray()
